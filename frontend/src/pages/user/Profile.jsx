...
const handleProfileUpdate = () => {
  ...
  return (
    <div className="p-2">
      ...
      {/* Personal Info */}
      <div className="md:grid grid-cols-12 gap-10 mt-5 md:mt-10">
        ...
        <div className="col-span-9 bg-white border border-gray-300 rounded-xl overflow-hidden mt-5 md:mt-0">
          <div className="p-6">
            <div>
            ...
            <div className="md:grid grid-cols-2 gap-5 md:mt-6">
              <div>
                <label className="text-sm font-medium text-gray-700">
                  Email
                </label>
